...
{
	/* Address,	  Length,     ResourceType,                  ResourceAttribute,                              CacheAttributes,                                 BuildHobOption, MemoryType */
	...
	/* HLOS Mem 1 -- UEFI Memory Pool Top */
	...
	/* HLOS Mem 2 */
	{ 0x04000000, 0x04800000, EFI_RESOURCE_SYSTEM_MEMORY,    SYSTEM_MEMORY_RESOURCE_ATTR_CAPABILITIES,       ARM_MEMORY_REGION_ATTRIBUTE_WRITE_BACK,          AddMem,     EfiConventionalMemory },
	...
	/* SMEM */
	{ 0x0D900000, 0x00100000, EFI_RESOURCE_MEMORY_RESERVED,  EFI_RESOURCE_ATTRIBUTE_UNCACHEABLE,             ARM_MEMORY_REGION_ATTRIBUTE_UNCACHED_UNBUFFERED, AddMem,     EfiReservedMemoryType },
	/* HLOS Mem 4 */
	...
	// CUSTOM ADD
	/* FrameBuffer */
	{ 0x0E400000, 0x00800000, EFI_RESOURCE_MEMORY_RESERVED,  EFI_RESOURCE_ATTRIBUTE_WRITE_THROUGH_CACHEABLE, ARM_MEMORY_REGION_ATTRIBUTE_WRITE_THROUGH,       AddMem,     EfiMaxMemoryType },
	/* Firmware location */
	{ 0x0EC00000, 0x00100000, EFI_RESOURCE_SYSTEM_MEMORY,    SYSTEM_MEMORY_RESOURCE_ATTR_CAPABILITIES,       ARM_MEMORY_REGION_ATTRIBUTE_WRITE_BACK,          AddMem,     EfiBootServicesCode},
    /* UEFI MEM POOL */
	{ 0x0ED00000, 0x03300000, EFI_RESOURCE_SYSTEM_MEMORY,    SYSTEM_MEMORY_RESOURCE_ATTR_CAPABILITIES,       ARM_MEMORY_REGION_ATTRIBUTE_WRITE_BACK,          AddMem,     EfiConventionalMemory },
	// CUSTOM END

	/* HLOS Mem 5 (original location: 0x0E400000, shifted for custom regions) */
	{ 0x12000000, 0x2E000000, EFI_RESOURCE_SYSTEM_MEMORY,    SYSTEM_MEMORY_RESOURCE_ATTR_CAPABILITIES,       ARM_MEMORY_REGION_ATTRIBUTE_WRITE_BACK,          AddMem,     EfiConventionalMemory },
	// 1GB
